	...
	while (1) {
		...
		switch (event.key.keysym.sym) {
			...
			case SDLK_ESCAPE:
                ...
                case SDLK_F11:
                  {
                    bool is_fullscreen = app->get_graphics()->isFullscreen();
                    app->get_graphics()->setFullscreen(!is_fullscreen);
                    must_redraw = true;
                  }
                  break;
			default:
	...
	while (true) {
		...
		switch (result) {
			case CONFIG_START_BOMBS:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_start_bombs( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_start_bombs() );
				}
				break;
			case CONFIG_START_POWER:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_start_power( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_start_power() );
				}
				break;
			case CONFIG_START_SKATES:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_start_skateboards( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_start_skateboards() );
				}
				break;
			case CONFIG_START_KICK:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_start_kick( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_start_kick() );
				}
				break;
			case CONFIG_START_GLOVE:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_start_glove( ((MenuItem_Value*)item)->get_value() );
				}
				else {
 					((MenuItem_Value*)item)->set_value( GameConfig::get_start_glove() );
				}
				break;
			case CONFIG_BOMBS:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_bombs( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_bombs() );
				}
				break;
			case CONFIG_POWER:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_power( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_power() );
				}
				break;
			case CONFIG_SKATES:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_skateboards( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_skateboards() );
				}
				break;
			case CONFIG_KICK:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_kick( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_kick() );
				}
				break;
			case CONFIG_GLOVE:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_glove( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_glove() );
				}
				break;
			case CONFIG_JOINT:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_joint( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_joint() );
				}
				break;
			case CONFIG_VIAGRA:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_viagra( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_viagra() );
				}
				break;
			case CONFIG_KOKS:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_koks( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_koks() );
				}
				break;
			case CONFIG_MAX_BOMBS:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_max_bombs( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_max_bombs() );
				}
				break;
			case CONFIG_MAX_POWER:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_max_power( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_max_power() );
				}
				break;
			case CONFIG_MAX_SKATES:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_max_skateboards( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_max_skateboards() );
				}
				break;
			case CONFIG_KIDS_MODE:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_kids_mode( ((MenuItem_Value*)item)->get_value() );
				}
				break;
			case CONFIG_CORPSE_PARTS:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_corpse_parts( ((MenuItem_Value*)item)->get_value() );
				}
				break;
			case CONFIG_SHAKE:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_shaky_explosions( ((MenuItem_Value*)item)->get_value() );
				}
				break;
			case CONFIG_BOMB_COUNTDOWN:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_bomb_countdown( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_bomb_countdown() );
				}
				break;
			case CONFIG_BOMB_DELAY:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_bomb_delay( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_bomb_delay() );
				}
				break;
			case CONFIG_BOMB_SPEED:
				if (ClanBomberApplication::is_server()) {
					...
					GameConfig::set_bomb_speed( ((MenuItem_Value*)item)->get_value() );
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_bomb_speed() );
				}
				break;
			case CONFIG_RANDOM_POSITIONS_DUPLICATE:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_random_positions( ((MenuItem_Value*)item)->get_value() );
					options_values[I_RANDOM_POS_NG]->set_value (GameConfig::get_random_positions());
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_random_positions() );
				}
				break;
			case CONFIG_RANDOM_MAP_ORDER_DUPLICATE:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_random_map_order( ((MenuItem_Value*)item)->get_value() );
					options_values[I_RANDOM_MAP_NG]->set_value (GameConfig::get_random_map_order());
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_random_map_order() );
				}
				break;
			case CONFIG_POINTS_DUPLICATE:
				if (ClanBomberApplication::is_server()) {
					GameConfig::set_points_to_win( ((MenuItem_Value*)item)->get_value() );
					options_values[I_POINTS_NG]->set_value (GameConfig::get_points_to_win());
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_points_to_win() );
				}
				break;
			case CONFIG_ROUND_TIME_DUPLICATE:
				if (ClanBomberApplication::is_server()) {
					...
					GameConfig::set_round_time( ((MenuItem_Value*)item)->get_value() );
					options_values[I_ROUND_TIME_NG]->set_value (GameConfig::get_round_time());
				}
				else {
					((MenuItem_Value*)item)->set_value( GameConfig::get_round_time() );
				}
				break;
			default:
				save_config = false;
...
{
	options_values[I_START_BOMBS]->set_value (GameConfig::get_start_bombs());
	options_values[I_START_POWER]->set_value (GameConfig::get_start_power());
	options_values[I_START_SKATES]->set_value (GameConfig::get_start_skateboards());
	options_values[I_START_KICK]->set_value (GameConfig::get_start_kick());
	options_values[I_START_GLOVE]->set_value (GameConfig::get_start_glove());
	options_values[I_BOMBS]->set_value (GameConfig::get_bombs());
	options_values[I_POWER]->set_value (GameConfig::get_power());
	options_values[I_SKATES]->set_value (GameConfig::get_skateboards());
	options_values[I_KICK]->set_value (GameConfig::get_kick());
	options_values[I_GLOVE]->set_value (GameConfig::get_glove());
	options_values[I_JOINT]->set_value (GameConfig::get_joint());
	options_values[I_VIAGRA]->set_value (GameConfig::get_viagra());
	options_values[I_KOKS]->set_value (GameConfig::get_koks());
	options_values[I_MAX_BOMBS]->set_value (GameConfig::get_max_bombs());
	options_values[I_MAX_POWER]->set_value (GameConfig::get_max_power());
	options_values[I_MAX_SKATES]->set_value (GameConfig::get_max_skateboards());
	//options_values[I_KIDS_MODE]->set_value (0);
	//options_values[I_CORPSE_PARTS]->set_value (0);
	//options_values[I_SHAKE]->set_value (0);
	options_values[I_BOMB_COUNTDOWN]->set_value (GameConfig::get_bomb_countdown());
	options_values[I_BOMB_DELAY]->set_value (GameConfig::get_bomb_delay());
	options_values[I_BOMB_SPEED]->set_value (GameConfig::get_bomb_speed());
	options_values[I_RANDOM_POS]->set_value (GameConfig::get_random_positions());
	options_values[I_RANDOM_MAP]->set_value (GameConfig::get_random_map_order());
	options_values[I_POINTS]->set_value (GameConfig::get_points_to_win());
	options_values[I_ROUND_TIME]->set_value (GameConfig::get_round_time());
	options_values[I_RANDOM_POS_NG]->set_value (GameConfig::get_random_positions());
	options_values[I_RANDOM_MAP_NG]->set_value (GameConfig::get_random_map_order());
	options_values[I_POINTS_NG]->set_value (GameConfig::get_points_to_win());
	options_values[I_ROUND_TIME_NG]->set_value (GameConfig::get_round_time());
...
void Menu::save_common_options (int id, bool options_menu_hack, bool force_save)
{
	...
	if ((force_save || save_config) &&
		...
		GameConfig::save();
		if (options_menu_hack) {
			GameConfig::set_filename ("clanbomber.cfg");
		}
		else {
			GameConfig::set_filename ("clanbomber_net.cfg");
		}
		GameConfig::load();
		GameConfig::set_random_positions (options_values[I_RANDOM_POS]->get_value());
		GameConfig::set_random_map_order (options_values[I_RANDOM_MAP]->get_value());
		GameConfig::set_points_to_win (options_values[I_POINTS]->get_value());
		GameConfig::set_round_time (options_values[I_ROUND_TIME]->get_value());
		GameConfig::save();
		if (options_menu_hack) {
			GameConfig::set_filename ("clanbomber_net.cfg");
		}
